...
public class AulaDidattica extends Aula {
    ...
    public AulaDidattica(int id, int numPosti, boolean proiettore, boolean microfono, boolean lavagna, boolean lavagnaInterattiva, boolean preseCorrente, boolean ethernet, String type, String typeAulaDIdattica) {
